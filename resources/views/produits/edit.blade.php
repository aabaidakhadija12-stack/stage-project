...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('produits.show', $produit) }}" class="text-decoration-none">{{ $produit->nom }}</a></li>
...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <p class="text-muted small mb-0">{{ $produit->nom }}</p>
    </div>
        ...
        <div class="card shadow-sm border-0 rounded-3">
            <div class="card-header py-3" style="border-bottom:1px solid rgba(255,255,255,.07);">
                <div class="d-flex align-items-center gap-2">
                    <div style="width:28px;height:28px;border-radius:7px;background:rgba(249,115,22,.2);display:flex;align-items:center;justify-content:center;color:#f97316;font-size:.85rem;"><i class="bi bi-pencil"></i></div>
                    <span style="font-weight:700;color:#f1f5f9;font-size:.82rem;">Modifier — {{ $produit->nom }}</span>
                </div>
            </div>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" id="quantiteStock" name="quantiteStock" min="0"
                                   ...
                                   value="{{ old('quantiteStock', $produit->quantiteStock) }}" required>
