...
<?php $__env->startSection('title', 'Modifier — ' . $client->nom); ?>
...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4 class="fw-bold mb-1">Modifier le client</h4>
        <p class="text-muted small mb-0"><?php echo e($client->nom); ?></p>
    </div>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('nom', $client->nom)); ?>" required autofocus>
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('adresse', $client->adresse)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <select id="user_id" name="user_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>"
                                    <?php echo e(old('user_id', $client->user_id) == $user->id ? 'selected' : ''); ?>>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('clients.index')); ?>" class="btn btn-outline-secondary">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projet-stage\resources\views\clients\edit.blade.php ENDPATH**/ ?>