...
<div class="d-flex flex-wrap gap-2 mb-4">
    ...
    <div style="display:flex;align-items:center;gap:.6rem;padding:.5rem 1rem;border-radius:10px;background:rgba(244,63,94,.1);border:1px solid rgba(244,63,94,.25);font-size:.78rem;color:#fda4af;">
        ...
        <span><strong style="color:#fb7185;"><?php echo e($stats['stock_rupture']); ?></strong> produit(s) en rupture de stock</span>
    </div>
    <?php endif; ?>
    ...
    <div style="display:flex;align-items:center;gap:.6rem;padding:.5rem 1rem;border-radius:10px;background:rgba(245,158,11,.1);border:1px solid rgba(245,158,11,.25);font-size:.78rem;color:#fcd34d;">
        ...
        <span><strong style="color:#fbbf24;"><?php echo e($stats['stock_faible']); ?></strong> produit(s) à stock faible</span>
    </div>
    <?php endif; ?>
    ...
    <div style="display:flex;align-items:center;gap:.6rem;padding:.5rem 1rem;border-radius:10px;background:rgba(6,182,212,.1);border:1px solid rgba(6,182,212,.25);font-size:.78rem;color:#67e8f9;">
        ...
        <span><strong style="color:#22d3ee;"><?php echo e($stats['commandes_en_attente']); ?></strong> commande(s) en attente de traitement</span>
    </div>
    <?php endif; ?>
</div>
<?php endif; ?>
        ...
        <div class="card chart-card h-100" style="border:1px solid rgba(245,158,11,.15);background:linear-gradient(135deg,rgba(245,158,11,.07),rgba(245,158,11,.02));">
            ...
            <div class="card-body d-flex flex-column align-items-center p-3">
                ...
                <div class="mt-3 w-100">
                    <?php $__currentLoopData = $stockParType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex justify-content-between align-items-center mb-1" style="font-size:.75rem;">
                        <span style="color:#94a3b8;"><?php echo e($item->type ?? 'Non défini'); ?></span>
                        <span style="font-weight:700;color:#e2e8f0;"><?php echo e($item->total); ?> u.</span>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card chart-card h-100" style="background:linear-gradient(135deg,rgba(16,185,129,.12),rgba(16,185,129,.04));border:1px solid rgba(16,185,129,.2);">
            <div class="card-header d-flex align-items-center gap-2" style="border-bottom:1px solid rgba(16,185,129,.15);background:transparent;">
                ...
                <span class="ms-auto" style="font-size:.65rem;color:#10b981;background:rgba(16,185,129,.12);border:1px solid rgba(16,185,129,.2);padding:.2rem .6rem;border-radius:20px;font-weight:600;"><?php echo e(now()->translatedFormat('M Y')); ?></span>
            </div>
            <div class="card-body py-3 px-4">
                <div style="font-size:2rem;font-weight:800;color:#10b981;letter-spacing:-.03em;line-height:1.1;"><?php echo e(number_format($caThisMonth, 0, ',', ' ')); ?> <span style="font-size:1rem;font-weight:600;opacity:.7;">DH</span></div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <div style="font-size:.78rem;font-weight:700;color:#e2e8f0;"><?php echo e(number_format($caLastMonth, 0, ',', ' ')); ?> DH</div>
                        <div style="font-size:.65rem;color:#64748b;">Mois précédent</div>
                    </div>
                    <div class="text-end">
                        <div style="font-size:.9rem;font-weight:800;color:<?php echo e($caEvolution >= 0 ? '#34d399' : '#fb7185'); ?>;">
                            <i class="bi bi-arrow-<?php echo e($caEvolution >= 0 ? 'up' : 'down'); ?>-short"></i><?php echo e($caEvolution >= 0 ? '+' : ''); ?><?php echo e($caEvolution); ?>%
                        </div>
    ...
    <div class="col-lg-4">
        <div class="card chart-card h-100" style="background:linear-gradient(135deg,rgba(245,158,11,.1),rgba(245,158,11,.03));border:1px solid rgba(245,158,11,.18);">
            ...
            <div class="card-body py-3 px-4">
                ...
                ?>
                <?php $__currentLoopData = $statutsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <div class="d-flex align-items-center gap-2">
                            <span style="width:8px;height:8px;border-radius:50%;background:<?php echo e($s['color']); ?>;display:inline-block;box-shadow:0 0 6px <?php echo e($s['color']); ?>;"></span>
                            <span style="font-size:.75rem;color:#94a3b8;font-weight:500;"><?php echo e($s['label']); ?></span>
                        </div>
                        <span style="font-size:.78rem;font-weight:700;color:#e2e8f0;"><?php echo e($s['count']); ?></span>
                    </div>
                    <div style="height:6px;border-radius:10px;background:rgba(255,255,255,.06);overflow:hidden;">
                        <div style="height:100%;width:<?php echo e(round(($s['count']/$totalCmd)*100)); ?>%;border-radius:10px;background:<?php echo e($s['color']); ?>;box-shadow:0 0 8px <?php echo e($s['color']); ?>;transition:width .8s ease;"></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <div style="height:1px;background:rgba(255,255,255,.06);margin:.75rem 0;"></div>
                <div style="font-size:.7rem;color:#64748b;text-align:center;">Total : <span style="color:#e2e8f0;font-weight:700;"><?php echo e($stats['commandes']); ?></span> commandes</div>
            </div>
        </div>
    </div>
        ...
        <div class="card chart-card h-100" style="background:linear-gradient(135deg,rgba(6,182,212,.1),rgba(6,182,212,.03));border:1px solid rgba(6,182,212,.18);">
            ...
            <div class="card-body py-3 px-4 d-flex flex-column justify-content-between">
                <div class="text-center py-2">
                    <div style="font-size:3rem;font-weight:800;color:#06b6d4;letter-spacing:-.04em;line-height:1;text-shadow:0 0 30px rgba(6,182,212,.4);"><?php echo e($stats['factures']); ?></div>
                ...
                <div class="text-center">
                    <div style="font-size:1.15rem;font-weight:800;color:#10b981;letter-spacing:-.02em;"><?php echo e(number_format($chiffreAffaires, 0, ',', ' ')); ?> DH</div>
