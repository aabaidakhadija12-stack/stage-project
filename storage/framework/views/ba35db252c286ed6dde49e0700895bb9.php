...
<?php $__env->startSection('title', 'Nouvelle maintenance'); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($produit->id); ?>"
                                    <?php echo e((old('produit_id', request('produit_id')) == $produit->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Détails de l'intervention..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projet-stage\resources\views\maintenances\create.blade.php ENDPATH**/ ?>