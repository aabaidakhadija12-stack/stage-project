...
<head>
    ...
    <title>FAC-<?php echo e(str_pad($facture->id, 4, '0', STR_PAD_LEFT)); ?></title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="invoice-meta">
                <strong>N°</strong> FAC-<?php echo e(str_pad($facture->id, 4, '0', STR_PAD_LEFT)); ?><br>
                <strong>Date :</strong> <?php echo e($facture->dateEmission->format('d/m/Y')); ?><br>
                <strong>Commande :</strong> CMD-<?php echo e(str_pad($facture->commande_id, 4, '0', STR_PAD_LEFT)); ?><br>
                <strong>Statut :</strong>
                <span class="status-badge status-<?php echo e($facture->commande->statut); ?>">
                    <?php echo e($facture->commande->statut_label); ?>
    ...
    <div class="info-row">
        <div class="info-box">
            ...
            <?php if($facture->commande->client): ?>
                <div class="info-box-name"><?php echo e($facture->commande->client->nom); ?></div>
                <div class="info-box-detail">
                    <?php echo e($facture->commande->client->adresse ?? ''); ?><br>
                    <?php echo e($facture->commande->client->telephone ?? ''); ?>
        ...
        <div class="info-box" style="margin-left:4%;">
            ...
            <div class="info-box-name"><?php echo e($facture->commande->fournisseur->nom); ?></div>
            <div class="info-box-detail"><?php echo e($facture->commande->fournisseur->contact ?? ''); ?></div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <table class="products-table">
        ...
        <tbody>
            ...
            <tr>
                <td class="fw-bold"><?php echo e($produit->nom); ?></td>
                <td><?php echo e($produit->type ?? '—'); ?></td>
                <td class="text-right"><?php echo e(number_format($produit->pivot->prix_unitaire, 2, ',', ' ')); ?> DH</td>
                <td class="text-center fw-bold"><?php echo e($produit->pivot->quantite); ?></td>
                <td class="text-right fw-bold"><?php echo e(number_format($produit->pivot->quantite * $produit->pivot->prix_unitaire, 2, ',', ' ')); ?> DH</td>
            </tr>
    ...
    <div class="totals-wrap">
        ...
        <div class="totals-box">
            <table class="totals-table">
                <tr>
                    <td>Sous-total HT</td>
                    <td><?php echo e(number_format($facture->montant, 2, ',', ' ')); ?> DH</td>
                </tr>
                <tr>
                    <td>TVA (20%)</td>
                    <td><?php echo e(number_format($facture->montant * 0.20, 2, ',', ' ')); ?> DH</td>
                </tr>
                <tr class="total-row">
                    <td>Total TTC</td>
                    <td><?php echo e(number_format($facture->montant * 1.20, 2, ',', ' ')); ?> DH</td>
                </tr>
            </table>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\projet-stage\resources\views/factures/pdf.blade.php ENDPATH**/ ?>